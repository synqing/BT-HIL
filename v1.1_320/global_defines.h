...
#define NUM_LEDS ( 160 ) // MUST be divisible by 2

// Hardware variant: ESP32-S3-DevKitC-1 with dual 160-LED strips
// Disable features not present on this hardware
#define DISABLE_TOUCH      // No touch sensing (GPIO 4 used for LED data)
#define DISABLE_INDICATOR  // No status LED (GPIO 11 not present)
